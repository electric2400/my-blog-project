      ...
      <section className="py-20 px-5">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-12 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-800">support@technews.com</p>
          </div>
          <div className="flex flex-col items-center">
        ...
        <div className="w-full max-w-3xl">
          ...
          <form className="flex flex-col gap-6">
            <input
              ...
              className="w-full p-4 rounded-lg bg-white/5 border border-gray-700 focus:border-blue-500 outline-none"
            />
            <input
              type="email"
            ...
            <button
              type="submit"
              className="px-8 py-4 rounded-lg bg-blue-600 hover:bg-blue-700 transition-all duration-200 text-lg font-semibold text-white"
            >
              Send Message
            </button>
          </form>
